...
if __name__ == "__main__":
    ...
    if conn is not None:
        insert_category(conn, "ssc resut", "All news related to ssc result")
        insert_author(conn, "Tasfia Tabassum MOHUA", "MOHUA@example.com")
        insert_editors(conn, "MD Kamal", "kamal@example.com")
